...
export function ProfileScreen({ profile, onSaved, onDeleted, onBack }: Props) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
      ...
      <Text style={styles.hint}>Datos solo en este celular (AsyncStorage).</Text>
      ...
      <View style={styles.actions}>
        <Button title="Guardar cambios" onPress={() => void handleSave()} />
