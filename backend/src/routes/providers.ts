...
providersRouter.get("/status", async (req, res) => {
  ...
  res.json({
    ...
    openaiTtsEnabled: real && openaiConfigured,
    openaiTtsModel: openaiConfigured ? env.openaiTtsModel : null,
    openaiTtsDefaultVoice: openaiConfigured ? env.openaiTtsDefaultVoice : null,
    openaiTest,
